...
(function ($) {
	...
	var resetMenu = function () {
		...
		$('.header').removeClass('light bg-white');
	}
	...
	$('.btn-toggle-layout').click(function () {
		...
		switch (action) {
			...
			case 'menuPinnedBelow':
				...
				$('.header').addClass('light bg-white');
				layoutOption = '4';
				break;
		}
	});
	...
	if (rtlSwitch != null) {
		rtlSwitch.onchange = function () {
			if (rtlSwitch.checked) {
				$('body').addClass('rtl');
				$('.main-stylesheet').attr('href', 'pages/css/themes/light.rtl.css');
			} else {
				$('body').removeClass('rtl')
				$('.main-stylesheet').attr('href', 'pages/css/themes/light.css');
